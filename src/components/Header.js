        ...
        return(
            <header>
                <div className="container">
                    <div className="brand">
                        <img className="logo" src={process.env.PUBLIC_URL + "images/Logo.png"} alt="Squanchy's Logo"/>
                    </div>

                    <div className="search">
                        <form action="#" method="get" className="search-form">
                            <input type="search" ref="searchBox" placeholder="Search for Squanchy Items" className="search-keyword" onChange={this.props.handleSearch}/>
                            <button className="search-button" type="submit" onClick={this.handleSubmit.bind(this)}>
                              <img className="search-icon" src={process.env.PUBLIC_URL + "images/search_icon.png"}/>
                            </button>
                        </form>
                    </div>
                    ...
                    <div className="cart">
                        ...
                        <a className="cart-icon" href="#" onClick={this.handleCart.bind(this)} ref="cartButton">
                            <img src={process.env.PUBLIC_URL + "images/squanch_sak.png"} alt="Squanch Sak"/>
                        ...
                        <div className={this.state.showCart ? "cart-preview active" : "cart-preview"} ref="cartPreview">
                            ...
                            <div className="action-block">
                                <button type="button" className={this.state.cart.length > 0 ? " " : "disabled"}>PURCHASE YOUR SQUANCH!</button>
                            </div>
                        </div>
                    </div>
                </div>
